...
def update_with_new_cmap(t):
    ...
    plt.imshow(Z, cmap="YlGn_r", extent=[x_min, x_max, y_min, y_max], origin='lower')
    ...
    top_height = bottom_height + abs((time - t) * 3)
...
ani.save("equal inclination interference.mp4", writer=writer)
